export default function Page() {
  return (
    <main className="flex w-full  flex-col items-center pt-10 p-2">
      ...
      <div className="flex flex-wrap justify-between w-full mb-4 border-solid  p-6 rounded-md shadow-xl  bg-white/75">
        <input
          type="text"
        ...
        <input
          ...
          className="input input-bordered input-accent w-full min-w-xs bg-transparent focus:border-2 focus:outline-none text-green-900 m-2"
        />
        <button className="shadow-lg m-2 btn btn-outline btn-success bg-green-500" style={{color:"white"}}>Kitob qoshish</button>
      </div>


      <div className="flex flex-wrap justify-between w-full  p-6 rounded-md shadow-xl mb-4 bg-white/75 gap-4">
        <select className="select select-success w-full min-w-xs bg-transparent focus:border-2 focus:outline-none text-green-900 ">
 ...
 {/* ===============================================Bo'limlarni qo'shish========================= */}
      <div className="gap-2 flex flex-wrap justify-between w-full  p-6 rounded-md shadow-xl bg-white/75 mb-4">
        <select className="select select-success w-full min-w-xs bg-transparent focus:border-2 focus:outline-none text-green-900 mb-2">
          <option disabled selected>
            Kitob nomini tanlang
          </option>
          <option>One Piece</option>
