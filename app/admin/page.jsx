export default function page() {
  return (
    <main className="flex w-full  flex-col items-center pt-24 p-6 ">
      <div className="flex flex-wrap justify-between w-2/3 mb-4 border-solid border-2 border-sky-500/50 p-6 rounded-md shadow-md mb-2 bg-white/75">
        <input
          type="text"
 ...
 {/* ===============================================Bo'limlarni qo'shish========================= */}
      <div className="flex flex-wrap justify-between w-2/3 border-solid border-2 border-sky-500/50 p-6 rounded-md shadow-md bg-white/75 mb-4">
      ...
      <div className="flex flex-wrap justify-between w-2/3 border-solid border-2 border-sky-500/50 p-6 rounded-md shadow-md bg-white/75">
        <select className="select select-success w-full max-w-xs bg-transparent focus:border-2 focus:outline-none text-green-900 mb-2">
          <option disabled selected>
            Kitob nomini tanlang
          </option>
